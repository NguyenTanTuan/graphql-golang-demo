...
func (ec *executionContext) field_Mutation_createNote_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewNote2githubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNewNote(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createNote(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNNote2ᚖgithubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNote(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_notes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Note)
	fc.Result = res
	return ec.marshalNNote2ᚕᚖgithubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNoteᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewNote2githubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNewNote(ctx context.Context, v interface{}) (model.NewNote, error) {
	res, err := ec.unmarshalInputNewNote(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNNote2githubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v model.Note) graphql.Marshaler {
	return ec._Note(ctx, sel, &v)
}

func (ec *executionContext) marshalNNote2ᚕᚖgithubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNoteᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Note) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNNote2ᚖgithubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNote(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNNote2ᚖgithubᚗcomᚋnguyentantuanᚋgraphqlᚑgolangᚑdemoᚋgraphᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v *model.Note) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
